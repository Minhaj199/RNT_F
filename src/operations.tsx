...
export class Operations implements IOperations {
  ...
  async createNode (nodeData:Partial<NodeData>,nodes:NodeData[]) {
    ...
    const result:{success:boolean,newData:NodeData}=await request({url:'/api/add-node',method:'post',data:{...newNode,level:newNode.level},headers:{'Content-Type':'application/json'}})
